...
class ProductDetailState {
  ...
  ProductDetailState() {
    ...
    productNameStyle = const TextStyle(fontFamily: 'Poppins',
        fontWeight: FontWeight.w800, fontSize: 28, color: customTextGreyColor);
    productPriceStyle = const TextStyle(fontFamily: 'Poppins',
        fontWeight: FontWeight.w700, fontSize: 18, color: Colors.white);
    productDescStyle = const TextStyle(fontFamily: 'Poppins',
        fontWeight: FontWeight.w400, fontSize: 15, color: customTextGreyColor);
    editButtonStyle = const TextStyle(fontFamily: 'Poppins',
    ...
    descTextStyle = const TextStyle(fontFamily: 'Poppins',
